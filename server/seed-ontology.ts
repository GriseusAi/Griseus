...
export async function seedOntology() {
  ...
  const createdCerts = await db.insert(certifications).values([
    { name: "OSHA 30", issuingBody: "OSHA / DOL", website: "https://www.osha.gov", validityYears: 5, description: "30-hour Occupational Safety and Health Administration construction safety training for supervisors and foremen." },
    { name: "OSHA 10", issuingBody: "OSHA / DOL", website: "https://www.osha.gov", validityYears: 5, description: "10-hour OSHA construction safety training covering hazard recognition for entry-level workers." },
    { name: "EPA 608 Universal", issuingBody: "EPA", website: "https://www.epa.gov/section608", validityYears: null, description: "EPA Section 608 Universal certification for handling all types of refrigerants in stationary equipment." },
    { name: "NFPA 70E", issuingBody: "NFPA", website: "https://www.nfpa.org", validityYears: 3, description: "Electrical safety in the workplace certification covering arc flash hazard analysis and safe work practices." },
    { name: "BICSI RCDD", issuingBody: "BICSI", website: "https://www.bicsi.org", validityYears: 3, description: "Registered Communications Distribution Designer certification for structured cabling system design." },
    { name: "First Aid/CPR", issuingBody: "American Red Cross", website: "https://www.redcross.org", validityYears: 2, description: "Basic first aid and CPR/AED certification for workplace emergency response." },
    { name: "Confined Space Entry", issuingBody: "OSHA / DOL", website: "https://www.osha.gov", validityYears: 1, description: "Training for safe entry and work in permit-required confined spaces per OSHA 29 CFR 1910.146." },
    { name: "NCCER Electrical", issuingBody: "NCCER", website: "https://www.nccer.org", validityYears: null, description: "National Center for Construction Education and Research electrical craft certification at various levels." },
    { name: "Journeyman Electrician License", issuingBody: "State Licensing Board", website: null, validityYears: 3, description: "State-issued journeyman electrician license permitting independent electrical work under a master electrician." },
    { name: "Master Electrician License", issuingBody: "State Licensing Board", website: null, validityYears: 3, description: "State-issued master electrician license permitting supervision of electrical installations and pulling permits." },
    { name: "AWS Welding Cert", issuingBody: "American Welding Society", website: "https://www.aws.org", validityYears: 2, description: "AWS D1.1 structural steel welding certification covering SMAW, GMAW, FCAW, and GTAW processes." },
    { name: "Rigging/Signal Person", issuingBody: "NCCCO", website: "https://www.nccco.org", validityYears: 5, description: "Qualified rigger and signal person certification for crane operations and heavy equipment lifts." },
    { name: "Forklift Operator", issuingBody: "OSHA / Employer", website: "https://www.osha.gov", validityYears: 3, description: "Powered industrial truck operator certification per OSHA 29 CFR 1910.178." },
    { name: "LEED AP", issuingBody: "USGBC", website: "https://www.usgbc.org", validityYears: 2, description: "Leadership in Energy and Environmental Design Accredited Professional for sustainable building practices." },
    { name: "CompTIA Network+", issuingBody: "CompTIA", website: "https://www.comptia.org", validityYears: 3, description: "Vendor-neutral networking certification covering infrastructure, operations, and security fundamentals." },
    { name: "NICET Fire Protection", issuingBody: "NICET", website: "https://www.nicet.org", validityYears: 3, description: "National Institute for Certification in Engineering Technologies fire protection engineering certification." },
    { name: "Tridium Niagara Certification", issuingBody: "Tridium / Honeywell", website: "https://www.tridium.com", validityYears: 2, description: "Certification for programming and configuring Tridium Niagara AX/N4 building automation framework." },
    { name: "ASHRAE Certification", issuingBody: "ASHRAE", website: "https://www.ashrae.org", validityYears: 3, description: "ASHRAE certification in HVAC design, operations, or building energy assessment for mechanical professionals." },
    { name: "NATE Certification", issuingBody: "NATE", website: "https://www.natex.org", validityYears: 2, description: "North American Technician Excellence certification for HVAC/R installation and service technicians." },
    { name: "R-410A Safety", issuingBody: "EPA", website: "https://www.epa.gov/section608", description: "Certification for safe handling and charging of R-410A refrigerant in modern HVAC systems." },
    { name: "UA Journeyman", issuingBody: "United Association", website: "https://ua.org", description: "United Association journeyman certification for pipefitters, plumbers, and steamfitters." },
    { name: "ASME B31.1/B31.3", issuingBody: "ASME", website: "https://www.asme.org", description: "Qualification under ASME pressure piping codes for power piping (B31.1) and process piping (B31.3)." },
    { name: "Backflow Prevention", issuingBody: "State/Local Authority", website: null, validityYears: 2, description: "Certification for installation and testing of backflow prevention assemblies in potable water systems." },
    { name: "BICSI Installer", issuingBody: "BICSI", website: "https://www.bicsi.org", validityYears: 3, description: "BICSI Installer certification for structured cabling installation, termination, and testing." },
    { name: "CompTIA A+", issuingBody: "CompTIA", website: "https://www.comptia.org", validityYears: 3, description: "Vendor-neutral IT certification covering hardware, software, networking, and troubleshooting fundamentals." },
    { name: "Schneider/Siemens PLC Cert", issuingBody: "Schneider Electric / Siemens", website: null, validityYears: 2, description: "Manufacturer certification for programming and configuring Schneider or Siemens PLC controllers." },
    { name: "BMS Certification", issuingBody: "Various (Tridium/Honeywell/JCI)", website: "https://www.tridium.com", validityYears: 3, description: "Certification in building management system programming, configuration, and integration." },
    { name: "ACI Flatwork Certification", issuingBody: "ACI", website: "https://www.concrete.org", validityYears: 5, description: "American Concrete Institute flatwork finisher/technician certification for slab and floor construction." },
    { name: "AWS D1.1 Structural Welding", issuingBody: "American Welding Society", website: "https://www.aws.org", validityYears: 2, description: "AWS D1.1 structural steel welding code qualification for building and bridge construction." },
  ]).returning();
