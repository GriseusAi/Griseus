...
**2026-05-03 hat focus düzeltmesi:** `production-line` kartına her sol tıklama artık sadece inspector açmaz; line meta'sındaki müşteri, teslim pill, kategori, mamul, Üretim/Depo/Satış, fabrika, flask ve aynı `groupId`'yi taşıyan edge uçlarını tekrar `manualFocusIds` içine alır. Böylece komut yazıldıktan sonra zincir kaybolsa bile hat kartına basınca üretim hattı yeniden yüzeye çıkar.
