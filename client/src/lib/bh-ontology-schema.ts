...
export const BH_ACTION_TYPES: Record<string, ActionTypeSpec> = {
  ...
  placeOrder: {
    ...
    description: "Kritik/darboğaz bileşen için tedarikçiye sipariş talebi oluşturur (purchase_suggestions)",
    targetObjectTypes: ["StockComponent", "Subassembly", "SubComponent"],
    status: "ACTIVE",
    parameters: [
      { apiName: "code", displayName: "Bileşen kodu", type: "String", required: true },
      { apiName: "quantity", displayName: "Miktar", type: "Integer", required: true, description: "Sipariş edilecek adet" },
      { apiName: "supplier", displayName: "Tedarikçi", type: "String", required: false, description: "Firma adı" },
      { apiName: "deadline", displayName: "Termin", type: "LocalDate", required: false, description: "Teslim tarihi (YYYY-MM-DD)" },
      { apiName: "note", displayName: "Not", type: "String", required: false },
    ],
  },
  ...
  transferStock: {
    ...
    description: "İki depo/lokasyon arasında stok hareketi kaydı (stock_transfers)",
    targetObjectTypes: ["StockComponent", "Subassembly"],
    status: "ACTIVE",
    parameters: [
      { apiName: "code", displayName: "Bileşen kodu", type: "String", required: true },
      { apiName: "fromLocation", displayName: "Kaynak depo", type: "String", required: true, description: "Örn: Merkez Depo" },
      { apiName: "toLocation", displayName: "Hedef depo", type: "String", required: true, description: "Örn: Üretim Hattı A" },
